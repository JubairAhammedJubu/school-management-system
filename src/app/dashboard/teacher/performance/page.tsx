    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-0.5">
              Attendance, exam, and assignment signals for every student — an assistive view, not a verdict.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      {!isLoading && !error && students.length > 0 && (
        <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xs p-5 sm:p-6">
          <p className="text-sm font-bold text-slate-900 dark:text-white">Class snapshot</p>
          <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
            How this group splits across the four performance bands.
          </p>
          <div className="mt-2 flex flex-col gap-4 sm:flex-row sm:items-end">
            ...
            <div className="flex flex-col items-stretch gap-1.5 sm:items-end sm:pb-2">
              {(
                [
                ...
                return (
                  <div
                    key={level}
                    className="w-full max-w-[240px] rounded-lg border border-slate-200 bg-slate-50 px-2.5 py-1.5 dark:border-slate-700 dark:bg-slate-800/70"
                  >
                    <p className="flex items-center gap-1.5 text-[11px] font-bold text-slate-800 dark:text-slate-100">
                      <span
                    ...
                    <p className="mt-0.5 pl-4 text-[10px] leading-snug text-slate-500 dark:text-slate-400">
                      {detail}
                    </p>
                  </div>
                );
