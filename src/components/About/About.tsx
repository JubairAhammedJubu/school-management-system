...
const roles = [
  {
    ...
    title: "Admins",
    description:
      "Manage the school structure, records, fees, notices, and reports from one place.",
  ...
  },
  {
    ...
    title: "Teachers",
    description:
      "Handle attendance, assignments, marks, and student progress with less manual work.",
  ...
  },
  {
    ...
    title: "Students",
    description:
      "Stay connected to classes, results, attendance, assignments, and important updates.",
...
const securityPoints = [
  {
    ...
    text: "Admins, teachers, and students only see what their role allows—no shared logins or open dashboards.",
  },
  {
    icon: Lock,
    title: "Secure sessions",
    text: "HTTP-only cookies and authenticated APIs protect accounts; sensitive actions stay server-side.",
  },
  {
    icon: BadgeCheck,
    title: "Approval & 2FA ready",
    text: "New accounts can wait for admin approval, with optional two-factor login for stronger account safety.",
  },
  {
    icon: EyeOff,
    title: "Safer payments & files",
    text: "Fee claims keep TrxID verification controlled; uploads are validated so only trusted files are stored.",
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-sm leading-relaxed text-slate-600 dark:text-slate-400 sm:text-base">
            EduNexus is a school management system built to replace scattered
            records and disconnected workflows with one clear digital ecosystem
            for administrators, teachers, and students—with security designed
            in from the start.
          </p>
        </motion.div>
        ...
        <div className="mt-14 grid items-stretch gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          >
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
              From daily attendance to long-term academic planning, EduNexus
              keeps essential information organized, accessible, and ready for
            ...
            <div className="grid flex-1 gap-4 sm:grid-cols-3 lg:gap-5">
              {roles.map((role, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`flex h-11 w-11 items-center justify-center rounded-xl ${role.surface} ${role.color}`}
                    >
            ...
            <div className="mt-5 flex items-center gap-4 rounded-2xl border border-blue-200/80 bg-blue-50/70 p-5 dark:border-blue-500/20 dark:bg-blue-500/10">
              ...
              <p className="text-xs leading-relaxed text-slate-700 dark:text-slate-300 sm:text-sm">
                <strong className="font-bold text-blue-700 dark:text-blue-300">
                  Better visibility, earlier support.
                </strong>{" "}
                EduNexus turns attendance, results, and assignments into useful
                signals for more informed educational decisions.
              </p>
            </div>
          </motion.div>
        </div>

        {/* Why schools choose us — security */}
        <motion.div
        ...
        >
          <div className="mx-auto max-w-2xl text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-slate-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300">
            ...
            <h2 className="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-3xl">
              ...
              <span className="block text-blue-600 dark:text-blue-500">
                and trust in daily operations.
              </span>
            </h2>
            <p className="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
              School data is sensitive. EduNexus is built so access is limited
              by role, logins are protected, and critical flows like fees and
              file uploads are checked before anything is saved.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {securityPoints.map((item, index) => {
              ...
              return (
                <motion.div
                  key={item.title}
                  className="rounded-2xl border border-slate-200/90 bg-white/90 p-5 shadow-lg shadow-slate-900/5 transition-all duration-300 hover:-translate-y-1 hover:border-blue-300/70 dark:border-slate-800 dark:bg-slate-900/70 dark:shadow-black/20 dark:hover:border-blue-700/50"
