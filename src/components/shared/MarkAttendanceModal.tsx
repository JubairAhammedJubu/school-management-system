          ...
          >
            ...
            <div className="relative shrink-0 flex items-start justify-between border-b border-slate-200 bg-white p-3.5 sm:px-6 sm:py-5 dark:border-slate-800 dark:bg-slate-950 gap-2.5 sm:gap-3">
              <div className="flex items-start gap-2.5 sm:gap-4 min-w-0 flex-1">
                <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-xl sm:rounded-2xl bg-indigo-50 font-black text-indigo-600 dark:bg-indigo-950/70 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/40 text-xs sm:text-sm shadow-xs">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <h2 className="mt-1 text-base sm:text-xl font-extrabold text-slate-900 dark:text-white leading-snug">
                    Mark Class Attendance
                  </h2>

                  <p className="mt-0.5 text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 font-medium">
            ...
            {/* Filter Bar (Class, Section A/B, Group, Date) */}
            <div className="shrink-0 border-b border-slate-200 bg-slate-50/70 p-3 sm:p-4 dark:border-slate-800 dark:bg-slate-900/60 z-30">
            ...
            <form onSubmit={handleSubmit} className="flex-1 flex flex-col min-h-0">
              <div className="flex-1 min-h-0 overflow-y-auto p-3 sm:p-6 space-y-2.5 custom-scrollbar">
                {error && (
                ...
                {isLoadingRoster ? (
                  <div className="space-y-2.5">
                    {Array.from({ length: 5 }).map((_, idx) => (
                      <div
                        key={idx}
                        className="flex flex-col xs:flex-row xs:items-center justify-between gap-2.5 rounded-xl border border-slate-200 bg-white p-3 shadow-xs dark:border-slate-800 dark:bg-slate-900 animate-pulse"
                      >
                  ...
                  filteredStudents.map((student) => (
                    <div
                      key={student.id}
                      className="flex flex-col xs:flex-row xs:items-center justify-between gap-2.5 rounded-xl border border-slate-200 bg-white p-3 shadow-xs transition-all hover:border-indigo-300 dark:border-slate-800 dark:bg-slate-900"
                    >
                      {/* Student Info */}
                      <div className="flex items-center gap-3 min-w-0 flex-1">
              ...
              <div className="shrink-0 flex items-center justify-between border-t border-slate-200 bg-slate-50/80 px-5 sm:px-6 py-4 dark:border-slate-800 dark:bg-slate-950">
